					...
					<div class="bg-body d-flex flex-column align-items-stretch flex-center rounded-4 w-md-500px p-20">
						...
						<div class="d-flex flex-center flex-column flex-column-fluid">
							...
							<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form">
								...
								<div class="text-center">
									<!--begin::Title-->
									<h2 class="text-primary fw-bolder mb-3">CONNEXION</h2>
									<!--end::Title-->
								</div>
								<!--begin::Heading-->
								<!--begin::Input group=-->
								<div class="fv-row mb-8">
									<!--begin::Login-->
									<input type="text" placeholder="Login" name="login" autocomplete="off" class="form-control bg-transparent" />
									<!--end::Login-->
								</div>
								<!--end::Input group=-->
								<div class="fv-row mb-3 position-relative">
                                	...
                                	<i class="fa fa-eye-slash text-primary viewPass"></i>
									<!--end::Password-->
								</div>
								<!--end::Input group=-->
								<!--begin::Wrapper-->
								<div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
									<div></div>
									<!--begin::Link-->
									<a href="/forgotpass" class="text-primary">Mot de passe oublié ?</a>
									<!--end::Link-->
								</div>
								<!--end::Wrapper-->
								<!--begin::Submit button-->
