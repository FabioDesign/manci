        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center">
              @if(in_array(3, Session::get('rights')[14]))
              ...
              <a href="#" class="status" data-h="{{ $data->id.'|'.$data->status.'|14' }}" data-bs-toggle="tooltip" data-bs-theme="tooltip-dark" data-bs-placement="top" title="{{ $titre }} le Nom"><i class="fas fa-{{ $icone }} fa-size {{ $color }}"></i></a>
              @else
              <a href="#"><i class="fas fa-{{ $icone }} fa-size text-muted"></i></a>
              @endif
              @if((in_array(8, Session::get('rights')[14]))&&(Myhelper::searchNom($data->id) == 0))
              <a href="#" class="status" data-h="{{ $data->id.'|2|14' }}" data-bs-toggle="tooltip" data-bs-theme="tooltip-dark" data-bs-placement="top" title="Supprimer le nom"><i class="fas fa-trash-alt fa-size text-violet"></i></a>
              @else
