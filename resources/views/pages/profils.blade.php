        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center">
              ...
              @endif
              @if(in_array(4, Session::get('rights')[4]))
              <a href="#" class="status" data-h="{{ $data->id.'|'.$data->status.'|4' }}" data-bs-toggle="tooltip" data-bs-theme="dark" data-bs-placement="top" title="{{ $titre }} du profil"><i class="fas fa-{{ $icone }} fa-size {{ $color }}"></i></a>
              @else
