        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center">
              ...
              @endif
              @if(in_array(4, Session::get('rights')[7]))
              <a href="#" class="status" data-h="{{ $data->id.'|'.$data->status.'|7' }}" data-bs-toggle="tooltip" data-bs-theme="tooltip-dark" data-bs-placement="top" title="{{ $titre }} le client"><i class="fas fa-{{ $icone }} fa-size {{ $color }}"></i></a>
              @else
              <a href="#"><i class="fas fa-{{ $icone }} fa-size text-muted"></i></a>
              @endif
              @if((in_array(8, Session::get('rights')[7]))&&(Myhelper::searchClt($data->id) == 0))
              <a href="#" class="status" data-h="{{ $data->id.'|2|7' }}" data-bs-toggle="tooltip" data-bs-theme="tooltip-dark" data-bs-placement="top" title="Supprimer le client"><i class="fas fa-trash-alt fa-size text-violet"></i></a>
              @else
