        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center">
              ...
              <a href="#" class="status" data-h="{{ $data->id.'|'.$data->status.'|7' }}" data-bs-toggle="tooltip" data-bs-theme="tooltip-dark" data-bs-placement="top" title="{{ $titre }} du client"><i class="fas fa-{{ $icone }} fa-size {{ $color }}"></i></a>
              @else
