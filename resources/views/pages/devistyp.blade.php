        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center">
              @if(in_array(4, Session::get('rights')[11]))
              <a href="#" class="status" data-h="{{ $data->id.'|'.$data->status.'|11' }}" data-bs-toggle="tooltip" data-bs-theme="tooltip-dark" data-bs-placement="top" title="{{ $titre }} Type Devis"><i class="fas fa-{{ $icone }} fa-size {{ $color }}"></i></a>
              @else
