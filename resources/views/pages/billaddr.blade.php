        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center">
              ...
              @endif
              @if((in_array(8, Session::get('rights')[10]))&&(Myhelper::searchAddr($data->id) == 0))
              <a href="#" class="status" data-h="{{ $data->id.'|2|10' }}" data-bs-toggle="tooltip" data-bs-theme="tooltip-dark" data-bs-placement="top" title="Supprimer Adresse facturation"><i class="fas fa-trash-alt fa-size text-violet"></i></a>
              @else
