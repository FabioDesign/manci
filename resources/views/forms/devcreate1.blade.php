...
<div class="card">
	...
	<div class="card-body p-12">
		...
		<form id="kt_invoice_form" class="formField" autocomplete="off">
			...
			<input type="hidden" id="mtremtyp" name="mtremtyp" value="0">
			<input type="hidden" id="solde" name="solde" value="0">
			<input type="hidden" id="devttr_id" name="devttr_id">
			<input type="hidden" id="seeremtyp" name="seeremtyp">
			<input type="hidden" name="type" value="add">
			<input type="hidden" name="mt_rem" value="0">
			<input type="hidden" name="mt_tva" value="0">
			<input type="hidden" id="id" name="id">
			<input type="hidden" name="see_rem">
			<input type="hidden" name="see_tva">
			<!--begin::Input group-->
			<div class="row g-9 mb-8">
				...
				<div class="col-sm-12 col-xl-3 fv-row">
					...
					<div class="position-relative d-flex align-items-center">
						...
						<!--end::Icon-->
						<!--begin::Datepicker-->
						<input id="date_at" name="date_at" class="form-control form-control-solid ps-12" readonly />
						<!--end::Datepicker-->
					</div>
					<!--end::Input-->
				</div>
